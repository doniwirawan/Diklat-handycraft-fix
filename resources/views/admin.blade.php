...
<header class="page-header">
  <nav>
    <a href="#0">
      <img class="logo" src="{{ URL::to('img/logo.png') }}" alt="forecastr logo">
    </a>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="{{ url('admin_konten') }}" class="{{ Request::is('admin_konten*') ? 'active' : '' }}">
          <svg>
            <use xlink:href="#collection"></use>
          </svg>
          <span>List & Input Produk</span>
        </a>
      </li>
      <li>
        <a href="{{ url('admin_komentar') }}" class="{{ Request::is('admin_komentar*') ? 'active' : '' }}">
          <svg>
